  ...
  const handleLogout = () => {
    ...
    const [inputReset, setInputReset] = useState({
      ...
      const handleChangeReset = (event) => {
        ...
        setInputReset({ ...inputReset, [name]: value });
      };
      const handleReset = (event) => {
        event.preventDefault();
        let { current_password,new_password, new_confirm_password } = inputReset;
        ...
        <div className="form-control w-full grid grid-cols-2 ">
          <div className="p-6">
            ...
            <input
              ...
              value={inputReset.current_password}
            ...
            <input
              ...
              value={inputReset.new_confirm_password}
              onChange={handleChangeReset}
